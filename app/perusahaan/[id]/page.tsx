            ...
            <div className={`max-w-xs rounded-[2.5rem] border-2 p-6 shadow-sm md:max-w-sm ${badgeConfig.color}`}>
              <div className="mb-4 flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="h-2 w-full overflow-hidden rounded-full border border-current border-opacity-10 bg-white/50">
                    <div className={`h-full ${badgeConfig.progressColor} transition-all duration-1000`} style={{ width: `${score}%` }}></div>
                  </div>
                </div>
              </div>
              <p className="border-t border-current border-opacity-10 pt-3 text-[11px] font-bold italic leading-relaxed opacity-80">
