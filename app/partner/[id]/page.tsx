      ...
      <header className="border-b-2 border-slate-100 bg-white shadow-sm">
        <div className="mx-auto max-w-7xl px-6 py-16">
          <div className="flex flex-col items-center gap-10 lg:flex-row lg:items-end">
            <div className="flex size-32 shrink-0 items-center justify-center animate-in zoom-in rounded-[2.5rem] border-4 border-white bg-slate-900 text-white shadow-2xl">
          ...
          <div className="space-y-20 lg:col-span-2">
            <section className="space-y-6">
              ...
              <div className="rounded-[3rem] border-2 border-slate-100 bg-white p-10 shadow-sm">
                <p className="whitespace-pre-line text-lg font-medium leading-relaxed text-slate-700 italic text-left">
                    ...
                    <div className="flex-1 space-y-4 text-left">
                      <div className="space-y-1">
                        ...
                        <div className="flex items-center gap-4 text-[10px] font-black uppercase italic tracking-tighter text-blue-600">
                          ...
                          <span className="flex items-center gap-1 text-slate-400 italic"><Calendar size={12} /> Mulai: {new Date(t.start_date).getFullYear()}</span>
                        </div>
                      </div>
                    </div>
