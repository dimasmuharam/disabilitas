          ...
          <div className="grid md:grid-cols-2 gap-10">
             <div className="bg-blue-50 p-6 rounded-3xl border border-blue-100 space-y-4">
                ...
                <p className="text-sm text-blue-800 leading-relaxed italic">
                  Berdasarkan dataset saat ini, talenta dari model sekolah Inklusi cenderung memiliki status <strong>Sudah Bekerja</strong> 15% lebih tinggi dibandingkan model SLB dalam kurun waktu 2 tahun setelah lulus.
                </p>
