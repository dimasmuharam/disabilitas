...
export function SiteHeader() {
  ...
  return (
    <>
      ...
      <a 
        href="#main-content" 
        className="sr-only focus:not-sr-only focus:absolute focus:z-[100] focus:bg-blue-600 focus:px-6 focus:py-4 focus:font-black focus:uppercase focus:text-white focus:outline-none focus:ring-4 focus:ring-yellow-400"
      >
