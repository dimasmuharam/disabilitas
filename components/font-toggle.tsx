...
export function FontToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center rounded-md p-2 hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-400"
    ...
    >
      <span className="font-bold text-sm mr-1">A{isLarge ? "-" : "+"}</span>
